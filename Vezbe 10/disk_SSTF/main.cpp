...
//
// Kod ovog načina raspoređivanja diska, iz skupa UI zahteva prednost ima onaj zahtev koji zahteva najmanje pomeranje ručice diska.
// Drugim rečima, pristupiće se onoj stazi koja je najbliža stazi na kojoj je trenutno glava diska.
//
// Klasa OS predstavlja deo operativnog sistema koji je zadužen za raspoređivanje zahteva.
// Metodu uputi_ui_zahtev pozivaju niti koje predstavljaju procese.
// U ovoj metodi postavlja se zahtev raspoređivaču diska da izvrši UI operaciju na određenoj stazi diska.
// Proces mora da sačeka da zahtev bude izvršen, pre nego nastavi dalje izvršavanje.
//
// Metodu obradi_zahtev poziva nit koja predstavlja raspoređivač diska. Metoda je zadužena da obradi jedan zahtev iz skupa zahteva.
