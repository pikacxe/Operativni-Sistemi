...
// Među procesima istog prioriteta, raspoređivanje se obavlja po FIFO principu (tj. ciklično će se smenjivati različite naredbe procesa istih prioriteta na procesoru).
//
