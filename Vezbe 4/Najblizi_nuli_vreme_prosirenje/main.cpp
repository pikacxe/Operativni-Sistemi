...
int main()
{
    ...
    for (int i = 0; i < BROJ_NITI; ++i)
    {
        duration<double, ratio<1, 1000>> ms = vremena[i].kraj - vremena[i].pocetak;
        duration<double> s = vremena[i].kraj - vremena[i].pocetak;
        duration<double, ratio<60,1>> min = vremena[i].kraj - vremena[i].pocetak;
        cout << "Vreme izvrsenja niti[" << i << "] = " << ms.count() << " ms" << endl;
        cout << "Vreme izvrsenja niti[" << i << "] = " << s.count() << " s" << endl;
        cout << "Vreme izvrsenja niti[" << i << "] = " << min.count() << " min\n\n" << endl;
