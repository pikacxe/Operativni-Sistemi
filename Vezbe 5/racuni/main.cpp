...
Taj niz sadrži onoliko elemenata koliko iznosi konstanta UKUPNO_RACUNA. Svaki element niza predstavlja jedan račun u banci.
...
Funkcija 10 puta na slučajan način bira dva računa i neki iznos novca i poziva funkciju prebaci() koja skida novac sa prvog racuna i dodaje ga na drugi račun. 
...
retVal prebaci(int izvor, int cilj, double iznos) {
    ...
    rez.staro = racuni[izvor];
    rez.novo = racuni[izvor] = racuni[izvor] - iznos;
    l.unlock();
